...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"counter\": () => (/* binding */ counter)\n/* harmony export */ });\n/* harmony import */ var _calcTotalPrice__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./calcTotalPrice */ \"./src/app/areas/shopping-cart/calcTotalPrice.js\");\n/* harmony import */ var _shared_localstorage_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../shared/localstorage_util */ \"./src/app/shared/localstorage_util.js\");\n\n\n\nclass Counter {\n  minusEl() {\n    const selectedDishes = document.querySelectorAll('.delivery-content__dish');\n    selectedDishes.forEach((item) => {\n      item\n        .querySelector('[data-action=\"minus\"]')\n        .addEventListener('click', () => {\n          const counter = item.querySelector('[data-counter]');\n          if (+counter.innerText > 1) {\n            counter.innerText = --counter.innerText;\n            const idDish = item\n              .querySelector('[data-id]')\n              .getAttribute('data-id');\n            _calcTotalPrice__WEBPACK_IMPORTED_MODULE_0__.calcTotalPrice.calcTotalPrice();\n            _shared_localstorage_util__WEBPACK_IMPORTED_MODULE_1__.localStorageUtil.removeProducts(idDish);\n          }\n        });\n    });\n  }\n\n  plusEl() {\n    const selectedDishes = document.querySelectorAll('.delivery-content__dish');\n    selectedDishes.forEach((item) => {\n      item\n        .querySelector('[data-action=\"plus\"]')\n        .addEventListener('click', () => {\n          const counter = item.querySelector('[data-counter]');\n          counter.innerText = ++counter.innerText;\n          const id = item.querySelector('[data-id]').getAttribute('data-id');\n          _calcTotalPrice__WEBPACK_IMPORTED_MODULE_0__.calcTotalPrice.calcTotalPrice();\n          _shared_localstorage_util__WEBPACK_IMPORTED_MODULE_1__.localStorageUtil.putProducts(id);\n        });\n    });\n  }\n}\n\nconst counter = new Counter();\n\n\n//# sourceURL=webpack://delivery_app/./src/app/areas/shopping-cart/counter.js?");

/***/ }),

/***/ "./src/app/areas/shopping-cart/order.js":
/*!**********************************************!*\
  !*** ./src/app/areas/shopping-cart/order.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"sendOrder\": () => (/* binding */ sendOrder)\n/* harmony export */ });\nasync function sendOrder(order) {\n  await fetch('http://localhost:7000/api/orders', {\n    method: 'POST',\n    headers: {\n      Accept: 'application/json, text/plain, */*',\n      'Content-Type': 'application/json',\n    },\n    body: JSON.stringify(order),\n  });\n}\n\n\n//# sourceURL=webpack://delivery_app/./src/app/areas/shopping-cart/order.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["src_assets_styles_style_scss"], () => (__webpack_require__("./src/app/areas/shopping-cart/shopping-cart.js")))
